...
return 7!==Object.defineProperty({},1,{get:function(){return 7}})[1]});var F={},M={};M=!$(function(){// eslint-disable-next-line es/no-function-prototype-bind -- safe
var e=(function(){}).bind();// eslint-disable-next-line no-prototype-builtins -- safe
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;F=M?x.bind(x):function(){return x.apply(x,arguments)};var P={}.propertyIsEnumerable,T=Object.getOwnPropertyDescriptor;o=T&&!P.call({1:2},1)?function(e){var t=T(this,e);return!!t&&t.enumerable}:P;var I={};I=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var q={},H={},N={},D=Function.prototype,A=D.call,C=M&&D.bind.bind(A,A),R={},W=(N=M?C:function(e){return function(){return A.apply(e,arguments)}})({}.toString),z=N("".slice);R=function(e){return z(W(e),8,-1)};var U=Object,G=N("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
H=$(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
...
(es=!!Object.getOwnPropertySymbols&&!$(function(){var e=Symbol("symbol detection");// Chrome 38 Symbol has incorrect toString conversion
...
ew=function(e,t){var r,n;if("string"===t&&X(r=e.toString)&&!K(n=F(r,e))||X(r=e.valueOf)&&!K(n=F(r,e))||"string"!==t&&X(r=e.toString)&&!K(n=F(r,e)))return n;throw ek("Can't convert object to primitive value")};var eE={},eS={};eS=!1;var eO={},ej={},eL=Object.defineProperty;ej=function(e,t){try{eL(O,e,{value:t,configurable:!0,writable:!0})}catch(r){O[e]=t}return t};var e$="__core-js_shared__";eO=O[e$]||ej(e$,{}),(eE=function(e,t){return eO[e]||(eO[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.32.1",mode:eS?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.32.1/LICENSE",source:"https://github.com/zloirock/core-js"});var eF={},eM={},ex=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
eM=function(e){return ex(B(e))};var eP=N({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
eF=Object.hasOwn||function(e,t){return eP(eM(e),t)};var eT={},eI=0,eq=Math.random(),eH=N(1..toString);eT=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eH(++eI+eq,36)};var eN=O.Symbol,eD=eE("wks"),eA=ea?eN.for||eN:eN&&eN.withoutSetter||eT,eC=TypeError,eR=(eF(eD,e="toPrimitive")||(eD[e]=es&&eF(eN,e)?eN[e]:eA("Symbol."+e)),eD[e]);// `ToPrimitive` abstract operation
...
var eB=Object.getOwnPropertyDescriptor;i=L?eB:function(e,t){if(e=q(e),t=Q(t),eW)try{return eB(e,t)}catch(e){}if(eF(e,t))return I(!F(o,e,t),e[t])};var eJ={},eY={};// V8 ~ Chrome 36-
...
indexOf:tH(!1)}.indexOf,tD=N([].push);tO=function(e,t){var r,n=q(e),i=0,o=[];for(r in n)!eF(ta,r)&&eF(n,r)&&tD(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)eF(n,r=t[i++])&&(~tN(o,r)||tD(o,r));return o};var tA=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");f=Object.getOwnPropertyNames||function(e){return tO(e,tA)},p=Object.getOwnPropertySymbols;var tC=N([].concat);// all object keys, includes non-enumerable and symbols
tS=ei("Reflect","ownKeys")||function(e){var t=f(eQ(e));return p?tC(t,p(e)):t},tE=function(e,t,r){for(var n=tS(t),o=0;o<n.length;o++){var a=n[o];eF(e,a)||r&&eF(r,a)||c(e,a,i(t,a))}};var tR={},tW=/#|\.prototype\./,tz=function(e,t){var r=tG[tU(e)];return r===tJ||r!==tB&&(X(t)?$(t):!!t)},tU=tz.normalize=function(e){return String(e).replace(tW,".").toLowerCase()},tG=tz.data={},tB=tz.NATIVE="N",tJ=tz.POLYFILL="P";tR=tz,/*
...
t9=/(?:ipad|iphone|ipod).*applewebkit/i.test(eu);var t8={};t8="process"===R(O.process);var t5=O.setImmediate,t6=O.clearImmediate,re=O.process,rt=O.Dispatch,rr=O.Function,rn=O.MessageChannel,ri=O.String,ro=0,ra={},rs="onreadystatechange";$(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t5&&t6||(t5=function(e){t4(arguments.length,1);var t=X(e)?e:rr(e),r=t3(arguments,1);return ra[++ro]=function(){tQ(t,void 0,r)},v(ro),ro},t6=function(e){delete ra[e]},t8?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t9?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!$(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rf=(tY={set:t5,clear:t6}).clear;// `clearImmediate` method
...
(this.arg=t),v}},e}({});try{regeneratorRuntime=rb}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=rb:Function("r","regeneratorRuntime = r")(rb)}const r_="https://forkify-api.herokuapp.com/api/v2/recipes/",rw="6851c9cd-479c-4f9d-adaf-5fe7a7bc3e48",rk=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},rE={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},rS=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceURL:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rO=async function(e){try{let t=await rk(`${r_}${e}?key=${rw}`);rE.recipe=rS(t),rE.bookmarks.some(t=>t.id===e)?rE.recipe.bookmarked=!0:rE.recipe.bookmarked=!1}catch(e){throw e}},rj=async function(e){try{rE.search.page=1,rE.search.query=e;let t=await rk(`${r_}?search=${e}&key=${rw}`);console.log(t),rE.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}}))}catch(e){throw e}},rL=function(e=rE.search.page){rE.search.page=e;let t=(e-1)*rE.search.resultsPerPage,r=e*rE.search.resultsPerPage;return rE.search.results.slice(t,r)},r$=function(e){rE.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rE.recipe.servings;//newQt = oldQt * (newServing/oldServing)
}),rE.recipe.servings=e},rF=function(){localStorage.setItem("bookmarks",JSON.stringify(rE.bookmarks));//store bookmarks in local storage under type of string with the name 'bookmarks'
},rM=function(e){//Add bookmark
rE.bookmarks.push(e),e.id===rE.recipe.id&&(rE.recipe.bookmarked=!0),rF()},rx=function(e){//when we want to add something we use the whole data, when we delete something we only need it's id
//Delete bookmark
let t=rE.bookmarks.findIndex(t=>t.id===e);rE.bookmarks.splice(t,1),e===rE.recipe.id&&(rE.recipe.bookmarked=!1),rF()};!function(){let e=localStorage.getItem("bookmarks");e&&(rE.bookmarks=JSON.parse(e));//convert string into object
}();const rP=async function(e){try{console.log(Object.entries(e));let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());// const ingArr = ing[1].replaceAll(' ', '').split(',');
if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,publisher:e.publisher,source_url:e.sourceUrl,image_url:e.image,servings:+e.servings,cooking_time:+e.cookingTime,ingredients:t};console.log(r);let n=await rk(`${r_}?key=${rw}`,r);rE.recipe=rS(n),rM(rE.recipe)}catch(e){throw e}};var rT={};rT=new URL(E("27Lyk").resolve("eyyUD"),import.meta.url).toString();class rI{_data;/**
...
this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));// console.log(newElements, curElements);
...
return 1!=t&&r.push(t),r;// Return the prime factors
  ...
  `}_generateMarkupIngredient(e){return`
              ...
              </li>`}}var rH=new rq;class rN{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rD=new rN,rA=new class extends rI{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
          <li class="preview">
            <a class="preview__link ${this._data.id===e?"preview__link":""}" href="#${this._data.id}">
...
(console.log(t),1===e&&t>1)?`
        <button data-goto="${e+1}" class="btn--inline pagination__btn--next">
          ...
          `:"")}}var rz=new rW;class rU extends rI{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet! Find a nice recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rA.render(e,!1)).join("")}}var rG=new rU;class rB extends rI{_parentElement=document.querySelector(".upload");_message="Congratulation! Recipe was successfully uploaded";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this));//Calling f.bind(someObject) creates a new function with the same body and scope as f, but the value of this is permanently bound to the first argument of bind, regardless of how the function is being called.
}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);//new FormData() will return weird object that we can not use, but we can spread it into array so that we can use
e(n)})}_generateMarkup(){}}var rJ=new rB;// if (module.hot) {
//   module.hot.accept();
// }
//https://forkify-api.herokuapp.com/v2
const rY=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rH.renderSpinner(),rR.update(rL()),rG.update(rE.bookmarks),//2) Loading recipe
await rO(e),rH.render(rE.recipe)}catch(e){rH.renderError()}},rQ=async function(){try{rR.renderSpinner();//1) Get search query
let e=rD.getQuery();if(!e)return;//2) Load search results
await rj(e),rR.render(rL(1)),rz.render(rE.search)}catch(e){console.log(e)}},rV=async function(e){try{rJ.renderSpinner(),//Upload the new recipe data
await rP(e),rH.render(rE.recipe),rJ.renderMessage(),rG.render(rE.bookmarks),//Update ID in URL
window.history.pushState(null,"",`#${rE.recipe.id}`),//Close form window, not do it immediately but after some time by using setTimeout()
setTimeout(function(){rJ.toggleWindow()},2500),console.log(rE.recipe)}catch(e){console.error("\uD83D\uDE1D",e),rJ.renderError(e.message)}};rG.addHandlerRender(function(){rG.render(rE.bookmarks)}),rH.addHandlerRender(rY),rH.addHandlerUpdateServings(function(e){//update the recipe servings (in the state)
r$(e),rH.update(rE.recipe)}),rH.addHandlerAddBookmark(function(){rE.recipe.bookmarked?rx(rE.recipe.id):rM(rE.recipe),console.log(rE.recipe),rH.update(rE.recipe),rG.render(rE.bookmarks)}),rD.addHandlerSearch(rQ),rz.addHandlerClick(function(e){rR.render(rL(e)),rz.render(rE.search)}),rJ.addHandlerUpload(rV);// controlRecipes();
...
*///# sourceMappingURL=index.c4302571.js.map
